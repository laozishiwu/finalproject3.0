    ...
    <div style="width: 88%;height: 90%;border: white solid 2px;margin: 2% auto;">
        ...
        <div style="float: left;width: 300px;height: 80%;border: lavender solid 2px;margin: 5% 1.5%;padding: 20% auto;text-align: center;">
            <form id="upFom2" method="post" enctype="multipart/form-data">
                ...
                图片描述：
                <input class="easyui-textbox" name="content" data-options="iconCls:'icon-search'" style="width:200px">
                <br/>
                <br/>
                <br/>
                <br/>
    ...
    $(function () {
        ...
        $('#dg').datagrid({
            ...
            columns: [[
                ...
                {field: 'title', title: '图片标题', width: 100, align: 'center'},
        ...
        $('#upFom2').form({
            url: '${pageContext.request.contextPath}/slideShow/uploadFile2.do',
