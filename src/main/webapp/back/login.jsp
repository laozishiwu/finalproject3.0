        ...
        <table>
            ...
            <tr>
                ...
                <td valign="middle" align="left">
                    ...
                    <img style="width:66px;height:30px;vertical-align:bottom;" id="num"
                         src="${pageContext.request.contextPath }/captcha/createCaptcha.do"
                         onclick="reloadCaptcha(this)"/>
                    <a href="javascript:;"
                       onclick="document.getElementById('num').src = '${pageContext.request.contextPath }/captcha/createCaptcha.do?'"
                       +Math.random()>换一张</a>
                </td>
            </tr>
            <tr>
